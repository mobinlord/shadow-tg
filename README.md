...
[![Join the chat at https://gitter.im/mobinlord/shadow-tg](https://badges.gitter.im/mobinlord/shadow-tg.svg)](https://gitter.im/mobinlord/shadow-tg?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)

**An advanced and powerful administration bot based on [yagop/telegram-bot](https://github.com/yagop/telegram-bot) licensed under the [GNU General Public License](https://github.com/mobinlord/shadow-tg/blob/master/LICENSE)**.
# Features
...
Check out this [tutorial by Telegram Geeks](http://telegramgeeks.com/2016/01/shadow-tg-tutorial/) for further assistance with setup and installation.

**Do not contact us** in private for support.
Join our bot development group by sending `/join 56670147` to [@shadowking](https://telegram.me/shadowking_TG)

# Special thanks to
[@pouria](https://telegram.me/redteam_01_13)

For managing [@shadowking](https://telegram.me/shadowking) on Telegram.
